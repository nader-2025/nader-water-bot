...
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN", "8124361757:AAF1uVCDv_ocLokKQd5ySde8AmYcSLe6wZA")
...
if __name__=="__main__":
    ...
    log.info("✅ بدء تشغيل البوت (v4.2 — تفعيل قائمة المسؤولين: إضافة/تعديل صلاحيات/حذف + باقي الميزات)")
    app=build_app()
